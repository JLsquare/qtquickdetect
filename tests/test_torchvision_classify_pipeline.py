...
def test_torchvision_classify_pipeline_images(test_images_path):
    """
    Test the TorchVisionClassifyPipeline with image input.
    """
    weight = "alexnet"
    results_path = Path("results")
    pipeline = TorchVisionClassifyPipeline(weight, preset, test_images_path, None, None, results_path)
...
def test_torchvision_classify_pipeline_videos(test_videos_path):
    """
    Test the TorchVisionClassifyPipeline with video input.
    """
    weight = "alexnet"
    results_path = Path("results")
    pipeline = TorchVisionClassifyPipeline(weight, preset, None, test_videos_path, None, results_path)
