...
class CollectionsWidget(QWidget):
    ...
    def collection_list_ui(self) -> QVBoxLayout:
        ...
        self._add_collection_button = QPushButton(self.tr('Add Collection'))
    ...
    def collection_buttons(self) -> QVBoxLayout:
        ...
        self._add_file_button = QPushButton(self.tr('Add File(s)'))
        ...
        self._add_folder_button = QPushButton(self.tr('Add Folder(s)'))
        ...
        self._delete_file_button = QPushButton(self.tr('Delete Selected File(s)'))
        ...
        self._delete_collection_button = QPushButton(self.tr('Delete Collection'))
